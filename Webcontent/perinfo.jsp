        ...
        <div class="box-inner">
            ...
            <div class="box-content">
                ...
                <table class="table table-striped table-bordered table-hover table-condensed">
                    ...
                    <tr>
                        <td>姓名</td>
                        <td id="perinfo_Name"></td>
                    </tr>
                    <tr>
                        <td>邮箱</td>
                        <td id="perinfo_Email"></td>
                    </tr>
                    <tr>
                        <td>性别</td>
                        <td id="perinfo_Sex"></td>
                    </tr>
                    <tr>
                        <td>专业</td>
                        <td id="perinfo_Major"></td>
                    </tr>
                    <tr>
                        <td>学院</td>
                        <td id="perinfo_College"></td>
                    </tr>
                    <tr>
                        <td>电话</td>
                        <td id="perinfo_Phone"></td>
                    </tr>
                    <tr>
                        <td>生日</td>
                        <td id="perinfo_Data"></td>
                    </tr>
                    </tbody>
                </table>
            </div>
...
<script src="static/js/perinfo.js"></script>
