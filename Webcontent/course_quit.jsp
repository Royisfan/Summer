                ...
                <div class="box col-md-12">
                    <div class="box-inner">
                        <div class="box-header well" data-original-title="">
                            <h2><i class="glyphicon glyphicon-star-empty"></i>退课</h2>
                            <div class="box-icon">
                        ...
                        <div class="box-content">
                            <form method="post" onsubmit="return checkIscheck()" action="QuitCourseServlet">
                            <table class="table table-striped table-bordered table-hover table-condensed">
                                <thead>
                                <tr>
                                    <th width="200px">已选课程</th>
                                    <th width="100px">学分</th>
                                    <th>确认退课</th>
                                </tr>
                                </thead>

                                <tbody id="course_quit">
                                </tbody>
                            </table>
...
<script src="static/js/course_quit.js"></script>
<% String message = null; 
%>
