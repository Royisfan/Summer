                ...
                <div class="box col-md-12">
                    <div class="box-inner">
                        <div class="box-header well" data-original-title="">
                            <h2><i class="glyphicon glyphicon-star-empty"></i>选择课程</h2>
                            <div class="box-icon">
                        ...
                        <div class="box-content">
                            <form method="POST" action="ChooseCourseServlet" onsubmit="return checkIscheck()">
                            <table class="table table-striped table-bordered table-hover table-condensed">
                                ...
                                <tbody id="course_select">
                                </tbody>
                            </table>
                                <input type="submit" class="btn btn-default" name="submit" value="确认">
...
<script src="static/js/course_seleceted.js"></script>
</body>
<% String message = null; 
%>
