...
<head>
    ...
    <link href="css/kebiao.css" rel="stylesheet">
        ...
        <div class="box-inner">
            ...
            <div class="box-content">
                <!-- put your content here -->
                 <form class="form-horizontal" role="form" action="ChangePasswordServlet" onsubmit="return CheckIsNull()">
                     <div class="form-group">
                         <label class="col-sm-2 control-label">输入原密码:</label>
                         <div class="col-sm-10">
                             <input type="password" class="form-control" name="forpassword" id="oldpsw">
                         </div>
                     </div>
                     <div class="form-group">
                         <label class="col-sm-2 control-label">请输入新密码:</label>
                         <div class="col-sm-10">
                             <input type="password" class="form-control" name="newpassword" id="newpsw1">
                         </div>
                     </div>
                     <div class="form-group">
                         <label class="col-sm-2 control-label">确认您的新密码:</label>
                         <div class="col-sm-10">
                             <input type="password" class="form-control" id="newpsw2" onblur="CheckIsSame()">
                         </div>
                     </div>
                     <div class="form-group">
