                ...
                <div class="box col-md-12">
                    <div class="box-inner">
                        <div class="box-header well" data-original-title="">
                            <h2><i class="glyphicon glyphicon-star-empty"></i>学科成绩</h2>
                            <div class="box-icon">
...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
         <form method="post"  action="AnswerUploadServlet" enctype="multipart/form-data">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                    <h4 class="modal-title" id="myModalLabel">提交你的作业</h4>
                </div>
                <div class="modal-body">
                    <input type="file" name="work">                    
                </div>
                <input type="hidden" name="job"  id="test" >
...
<script src="static/js/uncompleted_homework.js"></script>
<% String message = null; 
%>
